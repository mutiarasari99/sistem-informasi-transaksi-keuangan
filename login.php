...
<head>
  ...
  <style>
    ...
    .img {
      background: url('img/logo-pu.png');
      background-size: cover;
      background-position: center;
      height: 100%;
      top: 0;
          ...
          <div class="col-sm-6 p-0">
            <div class="card">
              <div class="card-header">
                ...
                <div class="sub-title">Registrasi untuk gunakan aplikasi</div>
              </div>
          ...
          <div class="col-sm-6 p-0">
            <div class="card">
              <div class="card-header">
                ...
                <div class="sub-title">Login untuk gunakan aplikasi</div>
              </div>
              <div class="icon-user">
                <h4 class="fa fa-user"></h4>
              </div>
